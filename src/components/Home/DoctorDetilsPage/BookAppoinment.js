      ...
      <div>
       ...
       {appointmentCheck && <form onSubmit={saveUser}>
        ...
        <div className={classes.input_group}>
          ...
          <input type="text" name="userName" placeholder="Enter name" value={input.userName} onChange={onInputChange} />
        </div>

        <div className={classes.input_group}>
          <label htmlFor="">Disease</label>
          <input type="text" name="disease" placeholder="Enter Disease" value={input.disease} onChange={onInputChange} />
        </div>

        <div className={classes.input_group}>
          <label htmlFor="">Email of Patient</label>
          <input type="text" name="patientEmail" placeholder="Enter Patient Email" value={input.patientEmail} onChange={onInputChange} />
        </div>
